...
public abstract class AbstractLiveAuthenService extends AbstractCameraBaseService implements LiveAuthenService {
	...
	private void initialize() {
		...
		fileName += File.separator + File.separator + "xiangji_test" + File.separator + name;
	...
	public byte[] readSnapPicture() {
		...
		try {
			FileOutputStream fout = new FileOutputStream(
					"/mnt/sdcard/xiangji_test/" + System.currentTimeMillis() + ".jpg");
	...
	public Bitmap createVideoPicture() {
		...
		return Bitmap.createBitmap(newBitmap, 0, 0, newBitmap.getWidth(), newBitmap.getHeight(), matrix, false);
	}
